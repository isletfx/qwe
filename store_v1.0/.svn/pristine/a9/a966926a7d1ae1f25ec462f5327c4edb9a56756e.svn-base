...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			...
			function del(pid){
				var flag = confirm("确定要下架该商品吗?");
				if(flag == true)
				window.location.href = "${pageContext.request.contextPath}/AdminProductServlet?method=pushDown&pid="+pid;
			}
		</script>
	</HEAD>
	<body>
								...
								<tr
									...
									<c:forEach var="p" items="${ pageBean.list }" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="17%">
												<img width="40" height="45" src="${ pageContext.request.contextPath }/jsp/${p.pimage}">
											</td>
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="17%">
												${p.pname }
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="">
													<img src="${pageContext.request.contextPath}/jsp/images/i_edit.gif" border="0" style="CURSOR: hand">
												</a>
											</td>
									
											<td align="center" style="HEIGHT: 22px">
												<a href="#" onclick="del('${p.pid}')">
													<img src="${pageContext.request.contextPath}/jsp/images/i_del.gif" width="16" height="16" border="0" style="CURSOR: hand">
												</a>
											</td>
										</tr>
									</c:forEach>
