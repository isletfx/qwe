...
<div class="container"  style="width:100%;height:460px;background:#FF2C4C url('${pageContext.request.contextPath }/jsp/images/loginbg.jpg') no-repeat;">
<div class="row"> 
	<div class="col-md-7">
...
<form class="form-horizontal" action="${pageContext.request.contextPath }/UserServlet" method="post">
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    ...
    style="background: url('${pageContext.request.contextPath }/jsp/images/login.gif') no-repeat scroll 0 0 rgba(0, 0, 0, 0);
