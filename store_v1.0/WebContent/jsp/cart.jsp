...
<html>
	...
	<body>
		...
		<c:if test="${ fn:length(cart.map) == 0 }">
			<center>
			<h1><img width="100px" height="50px" alt="" src="${pageContext.request.contextPath }/jsp/images/cart1.gif">购物车空空的哦,去看看心仪的商品吧</h1>
			...
			<div style="margin-right:130px;">
				...
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					...
					<a href="${pageContext.request.contextPath }/OrderServlet?method=saveOrder">
						<input type="button" width="100" value="提交订单" name="submit" border="0" style="background: url('${pageContext.request.contextPath}/jsp/images/register.gif') no-repeat scroll 0 0 rgba(0, 0, 0, 0);
