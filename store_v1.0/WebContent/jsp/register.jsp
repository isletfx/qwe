 		...
 		$("#username").blur(function(){
 			...
 			if(username !=""){
 				$.post("${pageContext.request.contextPath}/UserServlet",{"method":"checkUsername","username":username},function(data){
 	 				if(data == 1){
 	 					$("#s1").html("<font color = 'red'>用户名不可以使用</font>");
...
<div class="container" style="width:100%;background:url('${pageContext.request.contextPath }/jsp/image/regist_bg.jpg');">
<div class="row"> 
			...
			<div class="form-group">
			 ...
			 <div class="form-group">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-2">
			    <img src="${pageContext.request.contextPath }/jsp/image/captcha.jhtml"/>
			    </div>
			  ...
			  <div class="form-group">
			    <div class="col-sm-offset-2 col-sm-10">
			      <input type="submit"  id="regBut" width="100" value="注册"  border="0"
				    style="background: url('${pageContext.request.contextPath }/jsp/images/register.gif') no-repeat scroll 0 0 rgba(0, 0, 0, 0);
